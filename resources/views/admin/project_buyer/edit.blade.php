        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    ...
                    <!-- form start -->
                    <div class="col-md-8">
                        <form action="{{ route('projectbuyers.update', $projectbuyer->id) }}" method="POST"
                                        ...
                                        <div class="col-sm-6">
                                            <select class="form-control" name="project_id">
                                                @foreach ($projects as $item)
                                                    <option @if ($projectbuyer->project_id == $item->id) selected @endif value="{{ $item->id }}">{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input required type="text" class="form-control" id="name" name="name"
                                                placeholder="Enter Name" value="{{ $projectbuyer->name }}">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input required type="number" class="form-control" id="contact" name="contact"
                                                placeholder="Enter Contact Number" value="{{ $projectbuyer->contact }}">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea required rows="4" class="form-control" id="address" name="address"
                                                ...
                                                value=""> {{ $projectbuyer->address }} </textarea>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input required type="number" class="form-control" id="cnic" name="cnic"
                                                placeholder="Enter CNIC" value="{{ $projectbuyer->cnic }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="date" class="form-control" id="exampleInputEmail"
                                                ...
                                                value="{{ date('Y-m-d', strtotime($projectbuyer->dob)) }}" name="dob"
                                                required>
                                        </div>
