        ...
        <div class="row">
            <div class="filtersdiv">
                ...
                <div class="filters row" style="display:none">
                    <form action="{{ route('surveyproperties.filter') }}" >
                        @csrf
                        <div class="col-md-12">
                        ...
                        <div class="col-md-0 mx-3 my-3">
                            ...
                            <a href="{{ route('surveyproperties.index') }}"><button type="button"
        ...
        <div class="col-12">
                ...
                <div class="card-header" style="padding-left:1% ">
                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm">
                            <form action="{{ route('surveyproperties.index') }}" style="display: flex;">
                            ...
                            <a href="{{ route('surveyproperties.create') }}"><button type="button" class="btn btn-primary">Add
                                    Property</button></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-dark table-hover text-nowrap  thb">
                    ...
                    <tbody>
                        @forelse ($surveyproperties as $item)
                            <tr>
                                <td>{{ $item->id }}</td>
                                ...
                                <td>
                                    <a href="{{ route('surveyproperties.show', $item->id) }}" class="float-left"
                                        style="color: green"><i class="fas fa-edit"></i>EDIT</a>
                                </td>
                                <td>
                                    <a href="{{ route('surveyproperties.edit', $item->id) }}" class="float-left"><i
                                            class="fas fa-edit"></i></a>
                                    <form action="{{ route('surveyproperties.destroy', $item->id) }}" method="POST">
