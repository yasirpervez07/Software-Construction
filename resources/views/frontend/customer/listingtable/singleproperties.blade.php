                ...
                <div class="slider__image__detail-large owl-carousel owl-theme">
                    ...
                    <div class="item">
                        <div class="slider__image__detail-large-one">
                            <img src="https://chhatt.s3.ap-south-1.amazonaws.com/properties/{{ $item->name }}" alt=""
                    ...
                    @foreach ($property->images as $key => $item)
                        <div class="item">
                            <div class="slider__image__detail-thumb-one">
                                <img src="https://chhatt.s3.ap-south-1.amazonaws.com/properties/{{ $item->name }}" alt="" class="img-fluid w-100 img-transition">
                            </div>
                        </div>
                    @endforeach
