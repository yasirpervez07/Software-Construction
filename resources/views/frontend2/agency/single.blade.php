...
@section('content')
@include('frontend2.banners.agencybanner',['searchbar'=>false])
              ...
              <div class="col-md-3 text-center border-right">
                <div class="d-flex flex-column h-100">
                  ...
                  <div class="agent-listing text-center mt-auto">
                    <a href="#"><strong class="text-primary mr-2 d-inline-block">{{count($agency->properties)}}</strong>Listed Properties </a>
                  </div>
                </div>
              </div>
              <div class="col-md-9">
                <div class="d-flex h-100 flex-column">
                  <div class="agent-detail">
                    ...
                    <div class="agent-info">
                      ...
                      <p class="mt-3">“I’m not smart enough”, “I’m not lucky enough”, and the worst, “I’m not worthy” are but a few of the self-limiting beliefs I have encountered. We carry them with us like rocks in a knapsack, and then use them to sabotage our success. So, how twisted is that? One of the main areas that I work on with my clients is shedding these non-supportive beliefs.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="col-md-4 mt-sm-5">
          <div class="p-4 bg-light">
            ...
            <ul class="list-unstyled mb-0">
              <li class="mb-2"><strong class="text-dark d-inline-block mr-2">Address:</strong>{{$agency->user->address}}</li>
              <li class="mb-2"><strong class="text-dark d-inline-block mr-2">Website:</strong>{{$agency->user->address}}</li>
              <li class="mb-2"><strong class="text-dark d-inline-block mr-2">Agency:</strong>{{$agency->name}}</li>
              <li class="mb-2"><strong class="text-dark d-inline-block mr-2">Licenses:</strong>A42C3326</li>
              <li class="mb-2"><strong class="text-dark d-inline-block mr-2">Phone:</strong>{{$agency->user->phone}}</li>
              <li class="mb-2"><strong class="text-dark d-inline-block mr-2">Company:</strong>{{$agency->name}}</li>
              <li><strong class="text-dark d-inline-block mr-2">Mobile Number:</strong>{{$agency->user->mobile}}</li>
            </ul>
          </div>
        </div>
        <div class="col-md-8 mt-5">
          <div class="section-title mb-4">
            <h4>Contact {{$agency->name}}</h4>
          </div>
          <form>
            <div class="form-row">
        ...
        <div class="col-12">
          ...
          <div class="tab-content" id="pills-tabContent">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <ul class="list-unstyled list-style">
                    <li> <i class="far fa-check-circle font-md text-primary mr-2 mb-3"></i> Franklin’s extraordinary success in life.</li>
            ...
            <div class="tab-pane fade" id="listing" role="tabpanel" aria-labelledby="listing-tab">
              <div class="row">
            @include('frontend2.property.list-item',['properties'=>$agency->properties])
                  ...
                  <div class="col-md-4 mb-4 mb-md-0">
                    <div class="agent text-center">
                      <div class="agent-detail">
                        ...
                        <div class="agent-info">
                          <h6 class="mb-0"> <a href="agent-detail.html">{{$item->user->name}} </a></h6>
                      ...
                      <div class="agent-button">
                        <a class="btn btn-light btn-block" href="agent-detail.html">{{$item->user->phone}}</a>
                      </div>
                    </div>
                  </div>
                  @endforeach
